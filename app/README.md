...
Transcription uses the existing [YourMT3 Space](https://huggingface.co/spaces/mimbres/YourMT3). You can also upload an aligned MIDI file or start from the prepared example. The original MIDI is kept separately for `spansynth-edit + flowedit`.
